	...
	<div id="main" >
		<div class="text" style="margin-top:20px;">
			<p style="display: ${param.num==1?'block':'none'}">
				<img style="float:left;margin-right:20px;" src="<%=path%>/reception/images/about.jpg"> 重庆劲凯机电设备有限公司公司专用从事仓储物流设备的生产和销售，是国内最大的仓库物流设备供应商之一，公司的主要产品包括工位器具、工作台、工具柜、仓储货架、塑料制品、木制品、非标仓储盛具等。
